...
watch(isSurvivalMode, (isActivated) => {
  if (isActivated) {
    showCustomAlert("💀 ВНИМАНИЕ: Активирован режим выживания! Выплаты за круг отменены, 'Шанс' стал смертельным. Каждый круг необходимо платить налог в 200к", "danger");
    ...
    if (player.position === 39 && nextPosition === 0) {
     if (isSurvivalMode.value) {
      ...
      processTax(actor, 200);
        addLog(`Режим выживания! ${player.name} проходит круг без выплаты. ${player.name} оплачивает налог на доходы в размере 200k`);
      } else {
        const bonus = 500;
...
const steps = ref([
  ...
  { id: 5, name: 'Adidas', type: 'train', color: '#d31a2c', price: '2000', sellPrice: [1000], level: 1, rent: [280, 500, 1100, 2000], logo: '/img/ADIDAS.svg', description: 'Одежда и аксессуары', country: 'Германия', countryImg: '/img/flags/germany.svg', relations: 1 },
  ...
  { id: 15, name: 'Louis Vuitton', type: 'train', color: '#d31a2c', price: '2000', sellPrice: [1000], level: 1, rent: [280, 500, 1100, 2000], logo: '/img/lv.svg', description: 'Одежда и аксессуары', country: 'Франция', countryImg: '/img/flags/france.svg', relations: 1 },
  ...
  { id: 25, name: 'Nike', type: 'train', color: '#d31a2c', price: '2000', sellPrice: [1000], level: 1, rent: [280, 500, 1100, 2000], logo: '/img/nike.svg', description: 'Одежда и аксессуары', country: 'США', countryImg: '/img/flags/usa.svg', relations: 1 },
  ...
  { id: 31, name: 'Saudi Aramco', type: 'property', color: '#a54bef', price: '2600', sellPrice: [1300, 1900, 3400, 4900, 6400], rent: [217, 3600, 7800, 10400, 13000], level: 1, logo: '/img/sa.svg', description: 'Добыча, переработка и экспорт ресурсов', country: 'Саудовская Аравия', countryImg: '/img/flags/sa.svg', relations: 9 },
  { id: 32, name: 'Shell', type: 'property', color: '#a54bef', price: '2600', sellPrice: [1300, 1900, 3400, 4900, 6400], rent: [217, 3600, 7800, 10400, 13000], level: 1, logo: '/img/shell.svg', description: 'Добыча, переработка и экспорт ресурсов', country: 'Великобритания', countryImg: '/img/flags/uk.svg', relations: 9 },
  { id: 33, name: 'Шанс', type: 'chance', logo: '/img/question.svg' },
  { id: 34, name: 'Лукойл', type: 'property', color: '#a54bef', price: '2600', sellPrice: [1300, 1900, 3400, 4900, 6400], rent: [217, 3600, 7800, 10400, 13000], level: 1, logo: '/img/l.svg', description: 'Добыча, переработка и экспорт ресурсов', country: 'Россия', countryImg: '/img/flags/rus.svg', relations: 9 },
  { id: 35, name: 'Gucci', type: 'train', color: '#d31a2c', price: '2000', sellPrice: [1000], level: 1, rent: [280, 500, 1100, 2000], logo: '/img/gucci.svg', description: 'Одежда и аксессуары', country: 'Италия', countryImg: '/img/flags/italy.svg', relations: 1 },
